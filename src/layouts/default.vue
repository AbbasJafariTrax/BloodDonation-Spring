        ...
        <v-navigation-drawer v-model="drawer"
            ...
            <v-list dense>
                <v-list-item two-line @click="$router.push({name: 'MyProfile'})">
                    ...
                    <v-list-item-content>
                        <v-list-item-title>Abbas Jaffary</v-list-item-title>
                        <v-list-item-subtitle>abbasjaffary33@glmail.com</v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
...
export default {
    ...
    data: () => ({
        ...
        items: [
            ...
            {icon: 'mdi-login', text: 'SignUp', link: {name: 'Login'}},
